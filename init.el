...
;; https://github.com/emacs-eaf/emacs-application-framework/wiki/macOS
(setq eaf--mac-enable-rosetta t)
(add-to-list 'load-path "~/OtherPro/emacs-application-framework")
(require 'eaf)
(use-package eaf
  :load-path "~/OtherPro/emacs-application-framework"
  :custom
